...
def getPath(maze_file: str, startPoint: int):
    ...
    def ReadPath():
        ...
        startMission = re.search(r'\[Mission #(\d+)\] Heading to target node:\s+\d+,\s*current_cost:\s*(\d+\.?\d*)', line_str)
...
if __name__ == "__main__":
    ...
    for path, cost in getPath(FILE, startPoint):
            print(path)
            print(cost)    
